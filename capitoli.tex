...
\noindent
Gli assi sono logaritmici, quindi l'allineamento dei punti indica che il costo è
una legge di potenza. È ciò che ci si aspetta dalla forma del programma: l'ordinamento a bolle compie $O(n^2)$ confronti fra rotazioni, e ciascun confronto ne scandisce $O(n)$ caratteri.
...
\begin{tabular}{lll}
\hline
blocchi & un \texttt{par} per blocco (s) & un \texttt{par} solo (s)\\
\hline
2 & 0{,}71 & 0{,}62\\
4 & 1{,}49 & 1{,}11\\
6 & 2{,}21 & 1{,}67\\
...
\noindent
I dati mostrano che la versione con un unico \texttt{par} è più veloce di quella con un \texttt{par} per blocco, indicando che il parallelismo dichiarato dal linguaggio si realizza effettivamente.
