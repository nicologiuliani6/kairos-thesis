...
\centering
% Assi logaritmici in base 2: su di essi una legge di potenza appare come una retta
\begin{tikzpicture}[x=3.3cm,y=1.05cm]
  ...
  % retta dei minimi quadrati, pendenza 3,03
...
rami di un unico \texttt{par}, con il raccoglitore come ultimo ramo. 
\begin{center}
\begin{minipage}[t]{0.48\textwidth}
\centering
\textbf{Sequenziale}
\begin{lstlisting}
call bwt(b1, ..., offs1, sc1, out1, n, idx1)
call bwt(b2, ..., offs2, sc2, out2, n, idx2)
call raccoglitore(out1, out2, idx1, idx2, ...)
\end{lstlisting}
\end{minipage}
\hfill
\begin{minipage}[t]{0.48\textwidth}
...
\begin{lstlisting}
par
    call lavoratore(b1, ..., out1, c1, n)
and
    call lavoratore(b2, ..., out2, c2, n)
and
    call raccoglitore(c1, c2, col1, col2, indici, n)
rap
\end{lstlisting}
\end{minipage}
\end{center}
...
\begin{axis}[
    ...
    xlabel={Numero di blocchi},
    ylabel={Guadagno \texttt{par}},
    xtick={2,4,6,8},
    ymin=1,
    ymax=1.6,
    grid=major
...
Notiamo come, aumentando il numero di blocchi, il guadagno della versione \texttt{par} tenda complessivamente ad aumentare, mostrando un maggiore sfruttamento del parallelismo disponibile.
\section{Limiti}
