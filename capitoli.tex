...
\noindent
I dati mostrano che la versione con un unico \texttt{par} è più veloce di quella con un \texttt{par} per blocco. Con due nuclei il massimo teorico sarebbe $2\times$, e con otto rami si raggiunge il $73\%$ di questo massimo: il parallelismo dichiarato dal linguaggio si realizza con efficacia.
